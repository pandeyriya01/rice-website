          ...
          <div className="footer-section">
            <div className="footer-logo">
              ...
              <div className="footer-logo-text">
                ...
                <span className="company-name">Nyjah Exim Pvt Ltd</span>
              </div>
            </div>
            ...
            <div className="footer-social">
              ...
              <a href="https://www.linkedin.com/in/gaurav-vishnoi-b14530221" target="_blank" rel="noopener noreferrer">
                <FaLinkedin />
              </a>

              <a href="https://www.youtube.com/@Nyjahexim" target="_blank" rel="noopener noreferrer">
                <FaYoutube />
              </a>
            </div>
          </div>
